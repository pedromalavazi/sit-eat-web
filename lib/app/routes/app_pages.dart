...
import 'package:sit_eat_web/app/binding/waiting_list_binding.dart';
...
import 'package:sit_eat_web/pages/waitinglist/waiting_list_page.dart';
...
class AppPages {
  static final routes = [
    ...
    GetPage(
      name: Routes.WAITING_LIST,
      page: () => WaitingListPage(),
      binding: WaitingListBinding(),
      middlewares: [GlobalMiddleware()],
    ),
    GetPage(
      name: Routes.LOGS,
